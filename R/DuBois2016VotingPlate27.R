...
#Empty is representing the blank 
...
df$order <- factor(df$order, levels = c("B Voted", "B population", "B Registered","B empty",
                                        ...
                                        "W Voted", "W population", "W Registered","W empty" ,
                                        ordered = TRUE))
...
g1 <- grid::circleGrob(gp = grid::gpar(fill = "#EE3B3B")) #Red
g2 <- grid::circleGrob(gp = grid::gpar(fill = alpha("#1C86EE",0.8))) #Blue
g3 <- grid::circleGrob(gp = grid::gpar(fill = "#FFD700")) # Yellow
...
ggdraw(p03) +
  draw_label("Black", x = 0.50, y = 1.09, hjust = 0.50, vjust = 10, fontfamily = "Rajdhani", color = "black" ,size = 20) + 
  draw_label("White", x = 0.50, y = .28, hjust = 0.50, vjust = 10, fontfamily = "Rajdhani", color = alpha("black",0.8), size = 20) + 
  draw_label("Total Population", x= 0.39, y = 0.60, fontfamily = "Rajdhani", color = "black", size = 14) + 
  draw_label("Total Registered", x = .61, y = 0.65, vjust = 0.40 , fontfamily = "Rajdhani", color = "black", size = 14) +
  draw_label("Total Voted", x = 0.378, y = 0.70, fontfamily = "Rajdhani", color = "black", size = 14) +
  draw_label(bpopperc , x = 0.49, y = 0.95, hjust = 0.5, vjust = 10, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_label(wpopperc , x = 0.5, y = 0.15, hjust = 0.5, vjust = 0.5, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_label(bregPerc , x = 0.53, y = 0.95, hjust = 0.7, vjust = 10, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_label(wregPerc , x = 0.35, y = 0.35, hjust = 0.5, vjust = 0.5, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_label(bvotePerc , x = 0.46, y = 0.95, hjust = 0.5, vjust = 10, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_label(wvotePerc , x = 0.66, y = 0.37, hjust = 0.5, vjust = 0.5, fontfamily = "Rajdhani", color = "black", size = 13) +
  draw_grob(g1, x = -0.17, y = 0.10, scale = 0.04) +
  draw_grob(g2, x =-0.17, y = 0.20, scale = 0.04) +
  draw_grob(g3, x = 0.17, y = 0.15, scale = 0.04) 
